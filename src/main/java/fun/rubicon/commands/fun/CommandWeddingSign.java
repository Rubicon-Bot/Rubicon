 ...
 */
public class CommandWeddingSign extends CommandHandler {

    public CommandWeddingSign() {
        super(new String[]{"weddingsign"}, CommandCategory.FUN, new PermissionRequirements("weddingsign", false, true), "Creates a custom wedding sign for you.", "<text>");
    }
    ...
    protected Message execute(CommandManager.ParsedCommandInvocation invocation, UserPermissions userPermissions) throws Exception {
        ...
        String tombstoneUrl = "http://www.customweddingsign.com/generate.php"
