...
public class CommandRip extends CommandHandler {
    ...
    public CommandRip() {
        super(new String[]{"rip", "tombstone"}, CommandCategory.FUN, new PermissionRequirements(PermissionLevel.EVERYONE, "command.rip"), "Creates a tombstone for you", "rip <name> <text>");
    }
