...
public class CommandNow extends CommandHandler {
    ...
    public CommandNow() {
        super(new String[]{"now", "current", "playing"}, CommandCategory.MUSIC, new PermissionRequirements(PermissionLevel.EVERYONE, "command.now"), "Sends infos from current song.", "");
    }
